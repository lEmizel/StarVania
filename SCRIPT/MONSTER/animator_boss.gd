...
## Pilote d'animation du SKELETON_BOSS (gros mob d'élite) : hitbox
## d'attaque aux frames 4-5, FX de slash UNIQUEMENT sur l'attaque 1.
...
# --- FX de slash : réservé à l'attaque 1, même règle de vie que le joueur ---
	...
	match animation:
		"attack":
			match frame:
				...
				2:
					_play_slash()  # FX réservé à l'attaque 1
				4:
